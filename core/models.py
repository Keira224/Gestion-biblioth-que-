...
class ActivityType(models.TextChoices):
    ...
    OUVRAGE_MIS_A_JOUR = "OUVRAGE_MIS_A_JOUR", "Ouvrage mis a jour"
    OUVRAGE_SUPPRIME = "OUVRAGE_SUPPRIME", "Ouvrage supprime"
    EBOOK_AJOUTE = "EBOOK_AJOUTE", "Ebook ajoute"
    EBOOK_MIS_A_JOUR = "EBOOK_MIS_A_JOUR", "Ebook mis a jour"
    EBOOK_SUPPRIME = "EBOOK_SUPPRIME", "Ebook supprime"
